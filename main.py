...
from models.DSPNet import DSPNet
from models.MCT import MCT
# from models.CCNET import MYNET
# from models.DPNET import MYNET
# from models.NET import Net
from models.DLNET import MYNET
from utils import *
...
def main():
    ...
    if args.arch == 'SSFCNN':
      ...
      model = SpecCNN(args.scale_ratio, 
                     args.n_select_bands, 
                     args.n_bands).cuda()
    elif args.arch == 'MYNET':
      model = MYNET(args.scale_ratio,
                     args.n_select_bands,
                     args.n_bands).cuda()
    elif args.arch == 'MCT':
      model = MCT(args.arch,
                    ...
                    args.n_select_bands,
                    args.n_bands,).cuda()
    elif args.arch == 'DSPNet':
      model = DSPNet(args.arch,
                    args.scale_ratio,
                    args.n_select_bands,
                    args.n_bands, ).cuda()
    ...
    for epoch in range(args.n_epochs):
        ...
        fw = open("./data/test.txt", 'a')
        fw.write(str(recent_psnr))
        fw.write("\n")
        print ('psnr: ', recent_psnr)
        ...
        if is_best:
          ...
          # torch.save(model.state_dict(), './checkpoints/net.pt')
          print ('Saved!')
          print ('')
