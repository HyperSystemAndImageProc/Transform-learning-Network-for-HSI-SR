...
class MYNET(nn.Module):
    def __init__(self,
        ...
        self.pixel_shuffle1 = nn.PixelShuffle(2)
        self.pixel_shuffle2 = nn.PixelShuffle(4)
        self.conv4 = nn.Conv2d(n_bands+n_select_bands, n_bands+n_select_bands, kernel_size=3, stride=1, padding=1)#
    ...
    def forward(self, x_lr, x_hr):
        ...
        xl0 = self.conv4(xl0)  # n+5,128,128 
        #
        ...
        xl1 = self.conv5(xl1)  # n+1,128,128 
        # 
